...
function greeting(name) {
  return `<p style="color:rgba(255,255,255,0.9);font-size:15px;line-height:1.7;margin-bottom:6px;">สวัสดีครับคุณ <strong style="color:#FFFFFF;">${name || 'คุณ'}</strong> 👋</p>`;
}
